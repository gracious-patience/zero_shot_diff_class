...
class TestMetricIscFidelity(unittest.TestCase):
    ...
    def test_isc_pt_tf_fidelity(self):
        ...
        err_abs_mean = abs(
            res_ref[KEY_METRIC_ISC_MEAN] - res_fidelity[KEY_METRIC_ISC_MEAN]
        )
        err_abs_std = abs(
            res_ref[KEY_METRIC_ISC_STD] - res_fidelity[KEY_METRIC_ISC_STD]
        )
        ...
        self.assertAlmostEqual(
            res_fidelity[KEY_METRIC_ISC_MEAN], 4.51089784587268, delta=1e-5
        )
