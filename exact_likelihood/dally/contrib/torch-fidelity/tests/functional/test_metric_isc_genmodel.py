...
URL_SNGAN_MODEL = "https://github.com/toshas/torch-fidelity/releases/download/v0.2.0/example-sngan-cifar10-generator.pth"
...
class TestMetricIscGenModel(unittest.TestCase):
    ...
    def test_isc_gen_model(self):
        ...
        self.assertAlmostEqual(
            res_fidelity[KEY_METRIC_ISC_MEAN], 3.6213493416917104, delta=1e-5
        )
